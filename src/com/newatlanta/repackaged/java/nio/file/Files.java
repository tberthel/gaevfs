...
import com.newatlanta.repackaged.java.nio.file.spi.FileTypeDetector;
...
public final class Files {
    ...
    private static class DefaultFileTypeDetectorHolder {
     // GaeVFS: remove defaultFileTypeDetector
...
//            .probeContentType(file);
        return null; // GaeVFS: remove defaultFileTypeDetector
    }
     ...
     * com.newatlanta.repackaged.java.nio.file.attribute.BasicFileAttributes}. If the file is not a
     ...
     * com.newatlanta.repackaged.java.nio.file.attribute.BasicFileAttributes#fileKey file-key} of directories,
     ...
     * com.newatlanta.repackaged.java.nio.file.attribute.BasicFileAttributes#isDirectory isDirectory}
