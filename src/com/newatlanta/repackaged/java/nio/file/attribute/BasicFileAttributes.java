...
public interface BasicFileAttributes {
     ...
     * and two files are the {@link com.newatlanta.repackaged.java.nio.file.Path#isSameFile same} with
     * non-{@code null} file keys, then their file keys are equal.
     *
     * @see com.newatlanta.repackaged.java.nio.file.Files#walkFileTree
     */
    Object fileKey();
}
