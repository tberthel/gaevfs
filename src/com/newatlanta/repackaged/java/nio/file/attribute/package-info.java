 ...
 * <tr><td valign=top><tt><i>{@link com.newatlanta.repackaged.java.nio.file.attribute.AttributeView}</i></tt></td>
 *     <td>Can read or update non-opaque values associated with objects in a file system</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;<i>{@link com.newatlanta.repackaged.java.nio.file.attribute.FileAttributeView}</i></tt></td>
 *     <td>Can read or update file attributes</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link com.newatlanta.repackaged.java.nio.file.attribute.BasicFileAttributeView}&nbsp;&nbsp;</i></tt></td>
 *     <td>Can read or update a basic set of file attributes</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link com.newatlanta.repackaged.java.nio.file.attribute.PosixFileAttributeView}&nbsp;&nbsp;</i></tt></td>
 *     <td>Can read or update POSIX defined file attributes</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link com.newatlanta.repackaged.java.nio.file.attribute.DosFileAttributeView}&nbsp;&nbsp;</i></tt></td>
 *     <td>Can read or update FAT file attributes</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp<i>{@link com.newatlanta.repackaged.java.nio.file.attribute.FileOwnerAttributeView}&nbsp;&nbsp;</i></tt></td>
 *     <td>Can read or update the owner of a file</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link com.newatlanta.repackaged.java.nio.file.attribute.AclFileAttributeView}&nbsp;&nbsp;</i></tt></td>
 *     <td>Can read or update Access Control Lists</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link com.newatlanta.repackaged.java.nio.file.attribute.UserDefinedFileAttributeView}&nbsp;&nbsp;</i></tt></td>
 *     <td>Can read or update user-defined file attributes</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;<i>{@link com.newatlanta.repackaged.java.nio.file.attribute.FileStoreAttributeView}</i></tt></td>
 *     <td>Can read or update file system attributes</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link com.newatlanta.repackaged.java.nio.file.attribute.FileStoreSpaceAttributeView}&nbsp;&nbsp;</i></tt></td>
 ...
 * The {@link com.newatlanta.repackaged.java.nio.file.attribute.FileAttributeView} interface is
 ...
 * com.newatlanta.repackaged.java.nio.file.FileRef#getFileAttributeView} method with a
 * <em>type-token</em> to identify the required view. Views can also be identified
 * by name. The {@link com.newatlanta.repackaged.java.nio.file.attribute.FileStoreAttributeView} interface
 * provides access to file store attributes. A {@code FileStoreAttributeView} of
 * a given type is obtained by invoking the {@link
 * com.newatlanta.repackaged.java.nio.file.FileStore#getFileStoreAttributeView} method.
 *
 * <p> The {@link com.newatlanta.repackaged.java.nio.file.attribute.BasicFileAttributeView}
 * class defines methods to read and update a <em>basic</em> set of file
 * attributes that are common to many file systems.
 *
 * <p> The {@link com.newatlanta.repackaged.java.nio.file.attribute.PosixFileAttributeView}
 ...
 * standards.
 *
 * <p> The {@link com.newatlanta.repackaged.java.nio.file.attribute.DosFileAttributeView}
 ...
 *
 * <p> The {@link com.newatlanta.repackaged.java.nio.file.attribute.AclFileAttributeView}
 ...
 *
 * <p> The {@link com.newatlanta.repackaged.java.nio.file.attribute.FileStoreSpaceAttributeView} class
 * defines methods to read file system space usage related attributes of a file system.
 *
 * <p> The {@link com.newatlanta.repackaged.java.nio.file.attribute.Attributes} utility class defines
 ...
 * <ul>
 *
 *   <p><li> The {@link com.newatlanta.repackaged.java.nio.file.attribute.UserPrincipal} and
 *   {@link com.newatlanta.repackaged.java.nio.file.attribute.GroupPrincipal} interfaces represent an
 *   identity or group identity. </li>
 *
 *   <p><li> The {@link com.newatlanta.repackaged.java.nio.file.attribute.UserPrincipalLookupService}
 *   interface defines methods to lookup user or group principals. </li>
 *
 *   <p><li> The {@link com.newatlanta.repackaged.java.nio.file.attribute.FileAttribute} interface
