 ...
 * com.newatlanta.repackaged.java.nio.file.spi.FileSystemProvider provider} are generally interoperable
    ...
    implements FileRef, Comparable<Path>, Iterable<Path>, Watchable
{
   ...
   /**
     ...
     *
     * @see com.newatlanta.repackaged.java.nio.file.attribute.BasicFileAttributes#fileKey
     */
