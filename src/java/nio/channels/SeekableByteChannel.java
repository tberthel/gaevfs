 ...
 *
 * @since 1.7
 * @see com.newatlanta.nio.file.Path#newByteChannel
 */
    ...
    extends ByteChannel
{
     ...
     * the {@link com.newatlanta.nio.file.StandardOpenOption#APPEND APPEND} option, in
     ...
     * com.newatlanta.nio.file.StandardOpenOption#APPEND APPEND} option. When opened for
     ...
     * com.newatlanta.nio.file.StandardOpenOption#APPEND APPEND} option.
     *
     * @param  size
