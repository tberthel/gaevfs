 ...
 *
 * @since 1.7
 * @see com.newatlanta.repackaged.java.nio.file.Path#newByteChannel
 */
    ...
    extends ByteChannel
{
     ...
     * the {@link com.newatlanta.repackaged.java.nio.file.StandardOpenOption#APPEND APPEND} option, in
     ...
     * com.newatlanta.repackaged.java.nio.file.StandardOpenOption#APPEND APPEND} option. When opened for
     ...
     * com.newatlanta.repackaged.java.nio.file.StandardOpenOption#APPEND APPEND} option.
     *
     * @param  size
