 ...
 *
 * <p> The {@link com.newatlanta.repackaged.java.nio.file.FileStore#supportsFileAttributeView
 * supportsFileAttributeView} method may be used to test if a specific {@link
 * com.newatlanta.repackaged.java.nio.file.FileStore FileStore} supports the storage of user-defined
 * attributes.
 *
 * <p> Where dynamic access to file attributes is required, the {@link
 * com.newatlanta.repackaged.java.nio.file.FileRef#getAttribute getAttribute} method may be used to read
 * the attribute value. The attribute value is returned as a byte array (byte[]).
 * The {@link com.newatlanta.repackaged.java.nio.file.FileRef#setAttribute setAttribute} method may be used
